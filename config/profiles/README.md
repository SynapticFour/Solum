...
| `kenya-dpa.toml` | Present (**EVALUATION-ONLY** — non-counsel Vorprüfung; real counsel still required; not a production candidate) — Kenya DPA 2019 + Digital Health Act 2023; `customer_held` only |

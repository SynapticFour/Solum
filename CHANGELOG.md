...
- **Proof path** — Track A [WORKED-EXAMPLE.md](docs/WORKED-EXAMPLE.md) + [`examples/compliance-worked-example/`](examples/compliance-worked-example/) (Deny A capability fail-closed; Deny B consent gap documented); `verify.sh` §8; Track B [H3-WORKED-EVIDENCE.md](docs/H3-WORKED-EVIDENCE.md); IPS export + [FHIR-VALIDATION.md](docs/FHIR-VALIDATION.md) (`solum-example-fhir-ips-export`, `scripts/validate-fhir-ips.sh`); DE competence dossier [DE-FHIR-GAP.md](docs/DE-FHIR-GAP.md); pilot-gated [DE-ADAPTER-SPIKE.md](docs/DE-ADAPTER-SPIKE.md).

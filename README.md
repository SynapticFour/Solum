...
Solum is the clinical compliance sibling to [Ferrum](https://github.com/SynapticFour/Ferrum). **Who it is for:** [docs/IDENTITY.md](docs/IDENTITY.md). Related projects: **[docs/ECOSYSTEM.md](docs/ECOSYSTEM.md)**. Written commercial license (Solum is not a Ferrum add-on): [COMMERCIAL.md](docs/COMMERCIAL.md). BUSL parameters: [LICENSE-OPTIONS.md](docs/LICENSE-OPTIONS.md).

**Maturity:** this tree is weeks old (first commit 2026-07-22). Treat it as **evaluation / Stage-1**, not a production hospital system.
